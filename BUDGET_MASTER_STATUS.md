...
- **Lots restants** : L4 finitions (transferts/multi-devise E05) → L5 charges suisses (échéances annuelles) → L6 objectifs/scénarios → L7 onboarding (préférence thème à la bienvenue) → L8 qualité finale (320 px, a11y, hors-ligne, docs) → natif SwiftUI : reprendre les tokens Horizon (vérif CI macOS).
