...
- **Avancement** : **L0 ✓** (dd62c8d) · **L1 ✓** thème clair par défaut + sombre premium, tokens, bascule persistée, contrastes corrigés sur captures (97fc6fc, 71407f4, b1a1658) · **L2 ✓** recommandation du mois (5494194) · **L3 ✓** comparaison au mois précédent + inspection visuelle clair des 4 onglets (d8df878) · **L4 ✓ (cœur)** parité dette D04 alignée sur ADR-016, fixture renforcée (d75c8fd). **36 e2e + 4 parité verts.**
- **Programme Horizon terminé (2026-07-22)** : L5 ✓ charges de l'année (a4b130e) · L6 ✓ scénarios objectifs (0bc20ce) · L7 ✓ (couvert par l'existant + bascule d'apparence) · L8 ✓ qualité finale — 320 px sans débordement, ADR-019, docs (47ecd25) · **Natif étape 1 ✓** couleurs sémantiques dynamiques (c72e243, **CI macOS verte run 136** : build + ~190 tests + Release) · **E05 ✓** virement multi-devise converti (84e4026, CI verte run 137). État final : **39 e2e + 5 fixtures de parité verts, knownDifferences vide.** H01 sauvegarde guidée ✓ (27745c7, CI verte run 139) ; audit visuel clair complet (11 écrans, zéro défaut).
- **Restant** : G02 migration stockage centimes (effort dédié, non urgent — G01 arrondit déjà tout au centime) ; QA humaine sur iPhone ; TestFlight/prix/banque (décisions humaines).
