...
```text
(passe corrective L9 en cours — reprendre avec /budget-v1 continue)
```

L1 à L8 sont DONE. **L9 est IN_PROGRESS** : validation refusée le
25.07.2026, passe corrective en cours (voir « Refus L9 n°1 »). L'app
native n'a JAMAIS été installée sur un iPhone réel (aucun compte Apple
Developer, aucun TestFlight) ; haptique, Face ID réel et VoiceOver réel
restent PENDING HUMAN.
