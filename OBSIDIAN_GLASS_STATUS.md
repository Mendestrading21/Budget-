...
| L7 Onboarding/Confiance | VERIFYING | commit `acf28a7` ; CI #186 verte (run 30091710564 : 64 e2e + 5 parité + design, **249 tests iOS 0 échec**, ObsidianTrustTests + OnboardingViewModelTests passed, Debug+Release, manifeste) ; Demo vert (run 30092141510, tour 18 étapes asserté dont 16-documents et 17-suppression-annulee — dialogue destructif ouvert, prouvé, ANNULÉ —, artefact budget-demo 53,9 Mo, expire 22.10.2026) ; 19 captures PWA + README | validation humaine des surfaces de confiance |
